...
class _CheckoutViewState extends State<CheckoutView> {
  ...
  Future<void> initPaymentSession(
    ...
    CheckoutSettings _checkoutSettings = CheckoutSettings(
      ...
      headers: {
        ...
        'Abyan-token':
            'n2-7tIucvY2JaX2IllpXcmS-np6XVmRXlFtbVoN_cV9cikaSrLW5xoWRuqGzmVNsVltbwVaKWIKqbl5jkFlSe6iJklFbeXiDYmaTmF2KlFpcWrB8o0in',
  ...
  void onApplePay(double amount) async {
    ...
    final applePaySettings = ApplePaySettings(
      amount: amount,
      appleMerchantId: 'merchant.com.abyancapital.qa',
      countryCode: 'SA',
      currencyCode: 'SAR',
    );
