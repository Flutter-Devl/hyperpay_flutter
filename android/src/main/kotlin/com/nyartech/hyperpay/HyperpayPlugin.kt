...
/** HyperpayPlugin */
class HyperpayPlugin : FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    //     shopperResultUrl = "com.abyancapital.abyanflutter.payments"
    //     //shopperResultUrl += ".payments"
    //     Log.d(TAG, "SURL $shopperResultUrl")
    ...
    //         //                 "0.1",
    //         //                 "الرجاء تقديم علامة تجارية صالحة",
    //         //                 ""
    //         //         )
    //         //         else -> {
    ...
    //             val args: Map<String, Any> = call.arguments as Map<String, Any>
    //             checkoutID = (args["checkoutID"] as String?)!!
    //             var registrationID = (args["registrationID"] as String?)!!
    //             brand = Brand.valueOf(args["brand"].toString())
    ...
    //                 )
    //                 else -> {
    //                     val paymentParams: TokenPaymentParams = TokenPaymentParams(
    //                         checkoutID,
    //                         registrationID,
    //                         brand.name,
    //                         cvv
    ...
    //         result.error(
    //                 "1.1",
    //                 "معلومات البطاقة غير صحيحة ${brand.name}",
    //                 ""
    //         )
